...
public class SolarSystemRenderer implements GLSurfaceView.Renderer {
    ...
    private OnRendererReadyListener rendererReadyListener;
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        if (!isInitialized && rendererReadyListener != null) {
            isInitialized = true;
            new Handler(Looper.getMainLooper()).post(() -> rendererReadyListener.onRendererReady());
        }
    }
    ...
    private int loadShader(int type, String shaderCode) {
        ...
        if (compiled[0] == 0) {
            Log.e("ShaderError", "Could not compile shader " + type + ":");
            Log.e("ShaderError", GLES32.glGetShaderInfoLog(shader));
